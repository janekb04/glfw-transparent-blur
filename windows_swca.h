  ...
  if (hm) {
    ...
    const pSetWindowCompositionAttribute SetWindowCompositionAttribute =
        (pSetWindowCompositionAttribute)GetProcAddress(
            hm, "SetWindowCompositionAttribute");
    if (SetWindowCompositionAttribute) {
      ACCENT_POLICY policy = {ACCENT_STATE::ACCENT_ENABLE_ACRYLICBLURBEHIND, 2,
                              0x00FFFFFF,
                              0}; // and even works 4,0,155,0 (Acrylic blur)
      WINDOWCOMPOSITIONATTRIBDATA data = {
          WINDOWCOMPOSITIONATTRIB::WCA_ACCENT_POLICY, &policy,
  ...
  if (hm) {
    ...
    const pSetWindowCompositionAttribute SetWindowCompositionAttribute =
        (pSetWindowCompositionAttribute)GetProcAddress(
            hm, "SetWindowCompositionAttribute");
    if (SetWindowCompositionAttribute) {
      ACCENT_POLICY policy = {ACCENT_STATE::ACCENT_ENABLE_BLURBEHIND, 2,
                              0x00FFFFFF,
                              0}; // and even works 4,0,155,0 (Acrylic blur)
      WINDOWCOMPOSITIONATTRIBDATA data = {
          WINDOWCOMPOSITIONATTRIB::WCA_ACCENT_POLICY, &policy,
